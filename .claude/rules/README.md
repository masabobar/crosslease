...
| [`browser-verification.md`](browser-verification.md)             | Exercise every feature / bug fix in a real browser before handoff (Playwright MCP, `:5173`). Catches unrendered i18n keys, wrong role gates, console errors — adds no committed spec files | Every change with a UI surface                                                     |
