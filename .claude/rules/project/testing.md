...
> browser before handoff — see `.claude/rules/project/browser-verification.md`. That is interactive verification
...
- `.claude/rules/project/code-review.md` §9 — testing review checklist
- `.claude/rules/project/api-error-display.md` — error codes the UI must distinguish
