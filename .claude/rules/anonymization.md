...
- **Author of an input document:** the author field of the _input_ (e.g., "Brief by Marko Ilic") is metadata about the source — do NOT copy that field into the output. The generated doc has its own author field ("Generated by /process-client-docs").
