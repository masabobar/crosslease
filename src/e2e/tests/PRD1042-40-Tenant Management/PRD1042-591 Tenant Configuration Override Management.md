...
ACs with Gherkin scenarios: 8 of 16 | Blocked: 3 (D-Audit, Seed-Harness, PRD1042-77) | Excluded: 5 (edge-case or separate-feature — scope filter table only)
...
| AC-13 | Non-System-Admin roles receive 404 on all override endpoints (Front Office, Back Office/Risk, LC User, Support, Auditor)                            | `main-error`       | RefiNext 404-not-403 role pattern — critical security invariant, covered by Outline                                                                  |
...
**Gherkin generated for:** AC-01, AC-02, AC-07, AC-08, AC-09, AC-11 (+ AC-12), AC-13, AC-14
...
Active scenario blocks: 8 (2 Scenarios + 6 Scenario Outlines total across happy-path and error groups; count reflects distinct scenario blocks)
