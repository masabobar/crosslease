...
export const mockCases: CaseListItem[] = [
  ...
  },
  {
    ...
    last_activity_by_name: "Front Office",
    lessee_count: 2,
    primary_entity: "financing",
    decision_round: 0,
    waiting_on_roles: ["back_office_risk"],
    rate_due_date: "2026-09-18",
  },
  ...
  // in the Front Office work list with an origin mark.
  {
    ...
    last_activity_by_name: "Leasing Company",
    lessee_count: 3,
    primary_entity: "case",
    decision_round: 0,
    waiting_on_roles: ["front_office", "back_office_risk"],
    rate_due_date: null,
  },
  {
    ...
    last_activity_by_name: "Back Office",
    lessee_count: 4,
    primary_entity: "refinancing_request",
    decision_round: 0,
